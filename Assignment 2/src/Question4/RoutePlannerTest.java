...
public class RoutePlannerTest {
    ...
    {   System.out.println("------ JOURNEY PLANNER -----");
        ...
        List<BusJourney> options = planner.getPossibleJourneys("New Lynn", LocalTime.of(8,30), "Ponsonby", LocalTime.of(10,0));
        ...
        {   System.out.println("Journey Option "+(i+1)+": TOTAL COST: $"+options.get(i).getTotalCost()+"\n"+options.get(i));
        }
    }
